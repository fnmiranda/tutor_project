...
export default function PagePerfilAluno() {
  ...
  const listaMaterias = [
    ...
    "Algebra Linear",
    "Matematica",
    "Aritmetica Computacional de Ponta",
    "Computação",
  ];
  const suasMaterias = isOpenMaterias
    ? listaMaterias
    : listaMaterias.slice(0, 5);
  ...
  return (
    <div className="flex flex-col items-center justify-center px-10 mb-10">
      <div className="flex-1 flex-col w-full gap-2 items-center justify-center ">
        ...
        <Card className="border-gray-100 border-2 rounded-2xl  bg-white p-2 mt-8 mb-6">
          <div className="flex flex-wrap items-center gap-4">
            <div className="flex items-center p-6 gap-6 min-w-0">
              <div className="size-32 rounded-full border-blue-600 border-4 bg-blue-400 text-white flex items-center justify-center text-5xl font-semibold">
                <FaUser />
              </div>
              <div className="min-w-0">
                ...
                {/* <p className="flex flex-row gap-4 text-gray-500">
                  <span>10 Atividades entregues</span>
                ...
                <Button
                  className="flex flex-row mt-2 items-center justify-center gap-2 h-8 w-24 border-blue-500 bg-blue-600 rounded-md p-2 cursor-pointer
            ...
            <div className="ml-auto mr-8 flex gap-2">
              <Button
                className="flex items-center justify-center p-4 w-20 h-20  text-blue-500  rounded-full cursor-pointer  hover:bg-gray-100"
