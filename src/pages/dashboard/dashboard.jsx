...
const ProfessorDashboard = () => {
  ...
  const duvidas = [
    ...
    },
    {
      ...
      materia: 'Física',
      status: 'Respondido',
      conteudo: 'Preciso de ajuda para entender a aplicação das leis de Newton em exercícios.',
      aluno: 'Carlos Santos',
      tempo: '211d atrás',
      respondida: true,
      fechada: false
    },
    {
      ...
      materia: 'Português',
      status: 'Fechada',
      conteudo: 'Tenho dificuldade em identificar sujeito e predicado em frases complexas.',
      aluno: 'Maria Costa',
      tempo: '212d atrás',
      respondida: false,
      fechada: true
    ...
    <header className="bg-white shadow-sm gap-4">
          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center">
              <div className="hidden md:flex items-center">
                <span className="mr-3 text-sm text-gray-700">Professor Silva</span>
          ...
          <div className="md:hidden">
            ...
            <div className="pt-4 pb-3 border-t border-gray-200">
              <div className="flex items-center px-5">
                ...
                <div className="ml-3">
                  <div className="text-base font-medium text-gray-800">Professor Silva</div>
                  <div className="text-sm font-medium text-gray-500">prof.silva@escola.com</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mb-6 border-b border-gray-200">
          <nav className="flex space-x-8">
            <button
              onClick={() => setActiveTab('duvidas')}
              className={`py-4 px-1 font-medium text-sm ${activeTab === 'duvidas' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'}`}
            >
              Dúvidas dos Alunos
            </button>
            <button
              onClick={() => setActiveTab('perfil')}
              className={`py-4 px-1 font-medium text-sm ${activeTab === 'perfil' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'}`}
            >
              Perfil
            </button>
          </nav>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Dúvidas dos Alunos</h2>
              ...
              <div className="flex justify-between items-start mb-2">
                ...
                <div className="flex space-x-2">
                  <span className={`px-2 py-1 text-xs rounded-full ${
                    duvida.status === 'Nova mensagem' ? 'bg-blue-100 text-blue-800' :
                    duvida.status === 'Respondido' ? 'bg-green-100 text-green-800' :
